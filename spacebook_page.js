...
//Start code
        ...
        like_button ="<button class='btn btn-warning' id="+firebase_message_id+" value="+like+" onclick='updateLike(this.id)'>";
         ...
         edit_button ="<button class='btn btn-success' id='some' margin-right: 30px;";

        row = name_with_tag + message_with_tag +like_button + span_with_tag + edit_button;       
...
{
  firebase.database().ref(message_id).dit({
    message:message_id
  });
}
